...
## 2. [Solido/awesome-flutter](http://github.com/Solido/awesome-flutter)  ♥️ 20.3k
...
## 13. [OpenFlutter/Flutter-Notebook](http://github.com/OpenFlutter/Flutter-Notebook)  ♥️ 3.7k
...
## 15. [flutter/samples](http://github.com/flutter/samples)  ♥️ 3.5k
...
## 81. [shichunlei/flutter_app](http://github.com/shichunlei/flutter_app)  ♥️ 647
         
> 🔥🔥🔥本项目包括各种基本控件使用（Text、TextField、Icon、Image、Listview、Gridview、Picker、Stepper、Dialog、Slider、Row、Appbar、Sizebox、BottomS…
       

## 82. [gliheng/flutter-rs](http://github.com/gliheng/flutter-rs)  ♥️ 646
         
> Build beautiful desktop apps with flutter and rust. 🌠
 

## 83. [rrousselGit/flutter_hooks](http://github.com/rrousselGit/flutter_hooks)  ♥️ 634
         
> React hooks for Flutter. Hooks are a new kind of object that manages a Widget life-cycles. They are used to increase …
       

## 84. [bizz84/layout-demo-flutter](http://github.com/bizz84/layout-demo-flutter)  ♥️ 629
         
> Super Useful Flutter Layouts - Right in Your Pocket. 😉
 

## 85. [CarGuo/GSYGithubAppKotlin](http://github.com/CarGuo/GSYGithubAppKotlin)  ♥️ 628
         
> 超完整的Android Kotlin 项目，功能丰富，适合学习和日常使用。GSYGithubApp系列的优势：目前已经拥有Flutter、Weex、ReactNative、Kotlin四个版本。 功能齐全，项目框架内技术涉及面广，完成…
       

## 86. [X-Wei/flutter_catalog](http://github.com/X-Wei/flutter_catalog)  ♥️ 620
         
> An app showcasing Flutter components, with side-by-side source code view.
       

## 87. [cloudwebrtc/flutter-webrtc](http://github.com/cloudwebrtc/flutter-webrtc)  ♥️ 611
         
> Flutter WebRTC plugin for Mobile/Desktop
       

## 88. [pengMaster/BestNote](http://github.com/pengMaster/BestNote)  ♥️ 605
         
> 👊 持续更新，Java Android 近几年最全面的技术点以及面试题 供自己学习使用
       

## 89. [peng8350/flutter_pulltorefresh](http://github.com/peng8350/flutter_pulltorefresh)  ♥️ 601
         
> a widget provided to the flutter scroll component drop-down refresh and pull up load.
       


## 91. [google/flutter-provide](http://github.com/google/flutter-provide)  ♥️ 601
         
> A simple framework for state management in Flutter.
       

## 92. [brianegan/scoped_model](http://github.com/brianegan/scoped_model)  ♥️ 600
         
> A Widget that passes a Reactive Model to all of it's children
       

## 93. [burhanrashid52/WhatTodo](http://github.com/burhanrashid52/WhatTodo)  ♥️ 594
         
> A Simple Todo app design in Flutter to keep track of your task on daily basis. Its build on BLoC Pattern. You can add…
       

## 94. [Dart-Code/Dart-Code](http://github.com/Dart-Code/Dart-Code)  ♥️ 565
         
> Dart and Flutter support for VS Code
       

## 95. [CarGuo/GSYGithubAppWeex](http://github.com/CarGuo/GSYGithubAppWeex)  ♥️ 560
         
> 超完整的Weex开源项目，功能丰富，适合学习和日常使用。GSYGithubApp系列的优势：我们目前已经拥有Flutter、Weex、ReactNative、Kotlin四三个版本。 功能齐全，项目框架内技术涉及面广，完成度高，配套文…
       

## 96. [ibhavikmakwana/FlutterPlayground](http://github.com/ibhavikmakwana/FlutterPlayground)  ♥️ 558
         
> Playground app for Flutter
 

## 97. [songxiaoliang/visitor-flutter](http://github.com/songxiaoliang/visitor-flutter)  ♥️ 556
         
> 基于 Flutter & scoped_model 实现的视频类App客户端
       

## 98. [angel-dart/angel](http://github.com/angel-dart/angel)  ♥️ 548
         
> A polished, production-ready backend framework in Dart for the VM, AOT, and Flutter.
       

## 99. [zhujian1989/flutter_study](http://github.com/zhujian1989/flutter_study)  ♥️ 547
         
> flutter知识点学习与实战，问题解决方案记录
       

## 100. [aaronoe/FlutterCinematic](http://github.com/aaronoe/FlutterCinematic)  ♥️ 545
