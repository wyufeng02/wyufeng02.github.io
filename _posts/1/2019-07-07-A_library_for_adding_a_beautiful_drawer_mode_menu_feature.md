...
tag: [flutter, Menu, Drawer,抽屉模式菜单]
date: 2019-07-07
---
...
## [立即下载 ️⬇️ ](https://codeload.github.com/RafaelBarbosatec/hidden_drawer_menu/zip/master) 


 
![](https://flutterawesome.com/content/images/2019/07/Hidden-Drawer-MenuX.gif)
 
>
> 隐藏抽屉菜单是一个库，用于添加带有透视动画的漂亮抽屉模式菜单功能。
>
...
## Github主页 👉[RafaelBarbosatec/hidden_drawer_menu](http://github.com/RafaelBarbosatec/hidden_drawer_menu)