...
layout: post
title:  可定制圆形滑块
tag: [code4flutter,flutterAwesome , Circle, Slider]
date: 2019-06-10
---
...
有两种不同的选择：
 ...
 -  SingleCircularSlider：只有一个处理程序，可以移动拖动处理程序或只是单击滑块的不同部分。
 -  DoubleCircularSlider：有两个处理程序，必须通过拖动它们来移动它们。
...
![Move Selection](https://raw.githubusercontent.com/davidanaya/flutter-circular-slider/master/./doc/move-selection.gif)
...
![Sleep Single Slider Laps](https://raw.githubusercontent.com/davidanaya/flutter-circular-slider/master/./doc/single-slider-laps.gif)

![Sleep Double Slider Laps](https://raw.githubusercontent.com/davidanaya/flutter-circular-slider/master/./doc/double-slider-laps.gif)
