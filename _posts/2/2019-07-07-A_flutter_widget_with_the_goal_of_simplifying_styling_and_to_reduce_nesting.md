---
layout: post
title:  一个flutter的插件，目的是简化样式并减少嵌套
tag: [flutter, Widgets]
date: 2019-07-07
---
...
## [立即下载 ️⬇️ ](https://codeload.github.com/ReinBentdal/division/zip/master) 


 
![](https://flutterawesome.com/content/images/2019/06/divisionx.jpg)
 
>
> 一个flutter的插件，其目标是简化样式并减少嵌套，受CSS的启发
>
...
Widget child
## Github主页 👉[ReinBentdal/division](http://github.com/ReinBentdal/division)