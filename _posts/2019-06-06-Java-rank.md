...
## 5. [Snailclimb/JavaGuide](http://github.com/Snailclimb/JavaGuide)  ♥️ 43.2k
...
## 19. [doocs/advanced-java](http://github.com/doocs/advanced-java)  ♥️ 21.5k
...
## 51. [redisson/redisson](http://github.com/redisson/redisson)  ♥️ 9.4k
         
> Redisson - distributed Java objects and services (Set, Multimap, SortedSet, Map, List, Queue, Deque, Semaphore, Lock,…
       

## 52. [oracle/graal](http://github.com/oracle/graal)  ♥️ 9.3k
         
> GraalVM: Run Programs Faster Anywhere 🚀
 

## 53. [vondear/RxTool](http://github.com/vondear/RxTool)  ♥️ 9.3k
         
> Android开发人员不得不收集的工具类集合 | 支付宝支付 | 微信支付（统一下单） | 微信分享 | Zip4j压缩（支持分卷压缩与加密） | 一键集成UCrop选择圆形头像 | 一键集成二维码和条形码的扫描与生成 | 常用Dia…
       

## 54. [wasabeef/recyclerview-animators](http://github.com/wasabeef/recyclerview-animators)  ♥️ 9.2k
         
> An Android Animation library which easily add itemanimator to RecyclerView items.
       

## 55. [dbeaver/dbeaver](http://github.com/dbeaver/dbeaver)  ♥️ 9.2k
         
> Free universal database tool and SQL client
       

## 56. [prestodb/presto](http://github.com/prestodb/presto)  ♥️ 9.2k
         
> The official home of the Presto distributed SQL query engine for big data
       

## 57. [google/libphonenumber](http://github.com/google/libphonenumber)  ♥️ 9.1k
         
> Google's common Java, C++ and JavaScript library for parsing, formatting, and validating international phone numbers.
       

## 58. [mockito/mockito](http://github.com/mockito/mockito)  ♥️ 8.9k
         
> Most popular Mocking framework for unit tests written in Java
 

## 59. [naver/pinpoint](http://github.com/naver/pinpoint)  ♥️ 8.8k
         
> APM, (Application Performance Management) tool for large-scale distributed systems written in Java. 
       

## 60. [shichuan/javascript-patterns](http://github.com/shichuan/javascript-patterns)  ♥️ 8.8k
