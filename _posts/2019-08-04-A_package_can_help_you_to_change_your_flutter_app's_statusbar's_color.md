...
layout: post
title:  
tag: [flutter代码库, Status Bar, Color]
date: 2019-08-04
---
...
## [立即下载 ️⬇️ ](https://codeload.github.com/mchome/flutter_statusbarcolor/zip/master) 


 
![](https://flutterawesome.com/content/images/2019/07/flutter_statusbarcolor.jpg)
 
>
> 包可以帮助您以编程方式更改flutter应用程序的状态栏的颜色或导航栏的颜色。
>
...
## Github主页 👉[mchome/flutter_statusbarcolor](http://github.com/mchome/flutter_statusbarcolor)