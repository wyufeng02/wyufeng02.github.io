...
# [Platform Conforming Widgets for Flutter](http://github.com/fuzz-productions/platty) 
...
![Material Raised Button](https://github.com/fuzz-productions/platty/screenshots/materialbutton.png?raw=true)
![Cupertino Button](https://github.com/fuzz-productions/platty/screenshots/cupertinobutton.png?raw=true)

[Source](/example/lib/button_page.dart)

`FlatButton`/`CupertinoButton` -> `PFlatButton`

![Material Flat Button](https://github.com/fuzz-productions/platty/screenshots/androidflat.png?raw=true)
![Cupertino Flat Button](https://github.com/fuzz-productions/platty/screenshots/iosflat.png?raw=true)

[Source](/example/lib/button_page.dart)

`AppBar`/`CupertinoNavigationBar` -> `PNavigationBar`

![Android Nav](https://github.com/fuzz-productions/platty/screenshots/androidnav.png?raw=true)
![iOS Nav](https://github.com/fuzz-productions/platty/screenshots/iosnav.png?raw=true)
...
![Sliders](https://github.com/fuzz-productions/platty/screenshots/sliders.png?raw=true)

[Source](/example/lib/sliders_page.dart)

`Switch`/`CupertinoSwitch` -> `PSwitch`

![Switch](https://github.com/fuzz-productions/platty/screenshots/switches.png?raw=true)

[Source](/example/lib/switches_page.dart)

`BottomNavigationBar`/`CupertinoTabBar` -> `PTabBar`

![Bottom Navigation Android](https://github.com/fuzz-productions/platty/screenshots/androidtabs.png?raw=true)
![Bottom Navigation iOS](https://github.com/fuzz-productions/platty/screenshots/iostabs.png?raw=true)
...
![Progress](https://github.com/fuzz-productions/platty/screenshots/progress.png?raw=true)
...
![Android Alert](https://github.com/fuzz-productions/platty/screenshots/androidalert.png?raw=true)
![Ios Alert](https://github.com/fuzz-productions/platty/screenshots/iosalert.png?raw=true)
