...
#Android开源项目排行榜 (07-28)

![Android开源项目排行榜](http://code4flutter.oss-cn-beijing.aliyuncs.com/imgs/Android.png)


## 1. [flutter/flutter](http://github.com/flutter/flutter)  ♥️ 71.3k
         
> Flutter makes it easy and fast to build beautiful mobile apps.
       

## 2. [justjavac/free-programming-books-zh_CN](http://github.com/justjavac/free-programming-books-zh_CN)  ♥️ 52.9k
...
## 4. [wasabeef/awesome-android-ui](http://github.com/wasabeef/awesome-android-ui)  ♥️ 35.4k
...
## 63. [quasarframework/quasar](http://github.com/quasarframework/quasar)  ♥️ 11.3k
...
## 65. [CarGuo/GSYVideoPlayer](http://github.com/CarGuo/GSYVideoPlayer)  ♥️ 11.1k
...
## 67. [androidannotations/androidannotations](http://github.com/androidannotations/androidannotations)  ♥️ 10.9k
...
## 71. [android-async-http/android-async-http](http://github.com/android-async-http/android-async-http)  ♥️ 10.5k
         
> An Asynchronous HTTP Library for Android
 

## 72. [Curzibn/Luban](http://github.com/Curzibn/Luban)  ♥️ 10.4k
         
> Luban(鲁班)—Image compression with efficiency very close to WeChat Moments/可能是最接近微信朋友圈的图片压缩算法
       

## 73. [Konloch/bytecode-viewer](http://github.com/Konloch/bytecode-viewer)  ♥️ 10.4k
         
> A Java 8+ Jar & Android APK Reverse Engineering Suite (Decompiler, Editor, Debugger & More)
       

## 74. [Bigkoo/Android-PickerView](http://github.com/Bigkoo/Android-PickerView)  ♥️ 10.3k
         
> This is a picker view for android , support linkage effect, timepicker and optionspicker.（时间选择器、省市区三级联动）
       

## 75. [alibaba/ARouter](http://github.com/alibaba/ARouter)  ♥️ 10.3k
         
> 💪 A framework for assisting in the renovation of Android componentization (帮助 Android App 进行组件化改造的路由框架)
       

## 76. [kesenhoo/android-training-course-in-chinese](http://github.com/kesenhoo/android-training-course-in-chinese)  ♥️ 10.3k
         
> Android官方培训课程中文版
       

## 77. [JakeWharton/ViewPagerIndicator](http://github.com/JakeWharton/ViewPagerIndicator)  ♥️ 10.1k
         
> Paging indicator widgets compatible with the ViewPager from the Android Support Library and ActionBarSherlock.
       

## 78. [Tencent/VasSonic](http://github.com/Tencent/VasSonic)  ♥️ 10k
         
> VasSonic is a lightweight and high-performance Hybrid framework developed by tencent VAS team, which is intended to s…
       

## 79. [hehonghui/android-tech-frontier](http://github.com/hehonghui/android-tech-frontier)  ♥️ 10k
         
> 【停止维护】一个定期翻译国外Android优质的技术、开源库、软件架构设计、测试等文章的开源项目
       

## 80. [zhihu/Matisse](http://github.com/zhihu/Matisse)  ♥️ 9.9k
         
> 🎆 A well-designed local image and video selector for Android
 


## 81. [appium/appium](http://github.com/appium/appium)  ♥️ 9.8k
         
> 📱 Automation for iOS, Android, and Windows Apps.
       

## 82. [react-native-community/react-native-maps](http://github.com/react-native-community/react-native-maps)  ♥️ 9.7k
         
> React Native Mapview component for iOS + Android
 

## 83. [liaohuqiu/android-Ultra-Pull-To-Refresh](http://github.com/liaohuqiu/android-Ultra-Pull-To-Refresh)  ♥️ 9.7k
         
> Ultra Pull to Refresh for Android. Support all the views.
       

## 84. [alibaba/vlayout](http://github.com/alibaba/vlayout)  ♥️ 9.6k
         
> Project vlayout is a powerfull LayoutManager extension for RecyclerView, it provides a group of layouts for RecyclerV…
       

## 85. [kivy/kivy](http://github.com/kivy/kivy)  ♥️ 9.6k
         
> Open source UI framework written in Python, running on Windows, Linux, macOS, Android and iOS
       

## 86. [Tamsiree/RxTool](http://github.com/Tamsiree/RxTool)  ♥️ 9.6k
         
> Android开发人员不得不收集的工具类集合 | 支付宝支付 | 微信支付（统一下单） | 微信分享 | Zip4j压缩（支持分卷压缩与加密） | 一键集成UCrop选择圆形头像 | 一键集成二维码和条形码的扫描与生成 | 常用Dia…
       

## 87. [txthinking/brook](http://github.com/txthinking/brook)  ♥️ 9.5k
         
> Brook is a cross-platform(Linux/MacOS/Windows/Android/iOS) proxy/vpn software
       

## 88. [lipangit/JiaoZiVideoPlayer](http://github.com/lipangit/JiaoZiVideoPlayer)  ♥️ 9.4k
         
> Android VideoPlayer MediaPlayer VideoView MediaView Float View And Fullscreen.高度自定义的开源安卓视频框架
       

## 89. [pockethub/PocketHub](http://github.com/pockethub/PocketHub)  ♥️ 9.4k
         
> PocketHub Android App
       

## 90. [ksoichiro/Android-ObservableScrollView](http://github.com/ksoichiro/Android-ObservableScrollView)  ♥️ 9.4k
         
> Android library to observe scroll events on scrollable views.
       


## 91. [openstf/stf](http://github.com/openstf/stf)  ♥️ 9.4k
...
## 93. [xbmc/xbmc](http://github.com/xbmc/xbmc)  ♥️ 9.4k
         
> Kodi is an award-winning free and open source home theater/media center software and entertainment hub for digital me…
       

## 94. [didi/DoraemonKit](http://github.com/didi/DoraemonKit)  ♥️ 9.2k
         
> 简称 "DoKit" 。一款功能齐全的客户端（ iOS 、Android ）研发助手，你值得拥有。
       

## 95. [permissions-dispatcher/PermissionsDispatcher](http://github.com/permissions-dispatcher/PermissionsDispatcher)  ♥️ 9.2k
         
> Simple annotation-based API to handle runtime permissions.
       

## 96. [navasmdc/MaterialDesignLibrary](http://github.com/navasmdc/MaterialDesignLibrary)  ♥️ 9.1k
         
> This is a library with components of Android L to you use in android 2.2
       

## 97. [Yalantis/uCrop](http://github.com/Yalantis/uCrop)  ♥️ 9k
         
> Image Cropping Library for Android
 

## 98. [JakeWharton/RxBinding](http://github.com/JakeWharton/RxBinding)  ♥️ 9k
         
> RxJava binding APIs for Android's UI widgets.
       

## 99. [H07000223/FlycoTabLayout](http://github.com/H07000223/FlycoTabLayout)  ♥️ 8.9k
         
> An Android TabLayout Lib
       

## 100. [YoKeyword/Fragmentation](http://github.com/YoKeyword/Fragmentation)  ♥️ 8.8k
